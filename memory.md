...
- **Not implemented**: 4C real model sentiment (behind SENTIMENT_IMPL=model, disabled), TikTok/LINE + ranking v2 + export (Phase 5 — next). Cron auto-sync defer (Phase 3.5 bundle) — ตอนนี้ manual Sync button
