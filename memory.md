...
- **v2 ยังไม่เปิด** (`RANKING_ENGINE=v1`) — gate เปิดได้แล้ว รอ admin ตัดสิน. เปิดแล้ว v2 เปลี่ยนคำแนะนำจริง (Facebook→TikTok บน comedy pillar) และต้อง re-rank คู่ด้วย (content ที่ไม่เคย rank ด้วย v2 จะอ่านเป็น unranked)
